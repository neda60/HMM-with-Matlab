...
%bugIDs = importdata('I:\NEDA\FIREFOX DATA\HMM3\3buckets\allBugIds.mat');
%bugIDs = importdata('I:\NEDA\FIREFOX DATA\HMM_J\allBugIds.mat');
bugIDs = importdata(strcat(mainPath ,'\allBugIds.mat'));
...
%homePath = 'I:\NEDA\GNOME\HMM\Data\';
%homePath = 'I:\NEDA\FIREFOX DATA\HMM3\3buckets\Data\';
%homePath = 'I:\NEDA\FIREFOX DATA\HMM_J\Data\';
homePath = strcat(mainPath ,'Data\');
...
%save(strcat('I:\NEDA\GNOME\HMM\labels.txt'), 'labels1', '-ASCII'); % saving related lables(which trace belongs to which bucket)
%save(strcat('I:\NEDA\FIREFOX DATA\HMM3\3buckets\labels.txt'), 'labels1', '-ASCII'); % saving related lables(which trace belongs to which bucket)
save(strcat(mainPath ,'labels.txt'), 'labels1', '-ASCII'); % saving related lables(which trace belongs to which bucket)
...
% hmms = importdata(strcat('I:\NEDA\GNOME\HMM\HMM\hmms',num2str(N),'.mat'));
 %hmms = importdata(strcat('I:\NEDA\FIREFOX DATA\HMM3\3buckets\HMM\hmms',num2str(N),'.mat'));
 %hmms = importdata(strcat('I:\NEDA\FIREFOX DATA\HMM_J\HMM\hmms',num2str(N),'.mat'));
 hmms = importdata(strcat(mainPath ,'HMM\hmms',num2str(N),'.mat'));
...
%hmmPath = 'I:\NEDA\FIREFOX DATA\HMM_J\3buckets\HMM\';
...
%save(strcat('I:\NEDA\GNOME\HMM\Result\scores_hmm',num2str(N)),'scores');
%save(strcat('I:\NEDA\GNOME\HMM\Result\scores_hmm',num2str(N),'.txt'), 'scores', '-ASCII');
% save(strcat('I:\NEDA\FIREFOX DATA\HMM3\3buckets\Result\scores_hmm',num2str(N)),'scores');
% save(strcat('I:\NEDA\FIREFOX DATA\HMM3\3buckets\Result\scores_hmm',num2str(N),'.txt'), 'scores', '-ASCII');
% save(strcat('I:\NEDA\FIREFOX DATA\HMM_J\Result\scores_hmm',num2str(N)),'scores');
% save(strcat('I:\NEDA\FIREFOX DATA\HMM_J\Result\scores_hmm',num2str(N),'.txt'), 'scores', '-ASCII');
save(strcat(mainPath ,'Result\scores_hmm',num2str(N)),'scores');
save(strcat(mainPath ,'Result\scores_hmm',num2str(N),'.txt'), 'scores', '-ASCII');
...
% save(strcat('I:\NEDA\GNOME\HMM\Result\recog_',num2str(N)), 'recog');
% save(strcat('I:\NEDA\GNOME\HMM\Result\recog_',num2str(N),'.txt'), 'recog','-ASCII');
% save(strcat('I:\NEDA\FIREFOX DATA\HMM3\3buckets\Result\recog_',num2str(N)), 'recog');
% save(strcat('I:\NEDA\FIREFOX DATA\HMM3\3buckets\Result\recog_',num2str(N),'.txt'), 'recog','-ASCII');
% save(strcat('I:\NEDA\FIREFOX DATA\HMM_J\Result\recog_',num2str(N)), 'recog');
% save(strcat('I:\NEDA\FIREFOX DATA\HMM_J\Result\recog_',num2str(N),'.txt'), 'recog','-ASCII');
save(strcat(mainPath ,'Result\recog_',num2str(N)), 'recog');
save(strcat(mainPath ,'Result\recog_',num2str(N),'.txt'), 'recog','-ASCII');
